...
|----------------------------------|-------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| `plugins`                        | `str` | No       | Comma separated list of connection plugin codes. <br><br>Example: `failover_v2,host_monitoring_v2`                                                                                        | `aurora_connection_tracker,failover_v2,host_monitoring_v2` | 
